# whois_server_list = """""".split("\n")
# whois_server_dict = {item.split()[0]: item.split()[1] for item in whois_server_list}
# whois_server_dict 2019
whois_server_dict: dict[str, str] = {
    "aaa": "whois.nic.aaa",
    "aarp": "whois.nic.aarp",
    ...
    "hsbc": "whois.nic.hsbc",
    "ht": "whois.nic.ht",
    "https://whois.nic.sport": "whois.nic.spreadbetting",
    "hu": "whois.nic.hu",
    ...
    "xn--3oq18vl8pn36a": "whois.nic.大众汽车",
    ...
    "xn--cg4bki": "whois.nic.삼성",
    "xn--clchc0ea0b2g": "whois.sgnic.sg",
...
whois_server_dict2016: dict[str, str] = {
    "ac": "whois.nic.ac",
    "ad": "whois.ripe.net",
    "ae": "whois.aeda.net.ae",
    "aero": "whois.aero",
